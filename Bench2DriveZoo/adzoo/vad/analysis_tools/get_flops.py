...
import torch
from bench2driveMMCV import Config, DictAction
...
# try:
#     from bench2driveMMCV.cnn import get_model_complexity_info
# except ImportError:
#     raise ImportError('Please upgrade bench2driveMMCV to >0.6.2')
...
def get_modules_mapping():
    return {
        ...
        bench2driveMMCV.cnn.bricks.Conv2d: conv_flops_counter_hook,
        nn.Conv3d: conv_flops_counter_hook,
        bench2driveMMCV.cnn.bricks.Conv3d: conv_flops_counter_hook,
        # activations
        ...
        bench2driveMMCV.cnn.bricks.MaxPool2d: pool_flops_counter_hook,
        nn.MaxPool3d: pool_flops_counter_hook,
        bench2driveMMCV.cnn.bricks.MaxPool3d: pool_flops_counter_hook,
        ...
        bench2driveMMCV.cnn.bricks.Linear: linear_flops_counter_hook,
        # Upscale
        nn.Upsample: upsample_flops_counter_hook,
        # Deconvolution
        nn.ConvTranspose2d: deconv_flops_counter_hook,
        bench2driveMMCV.cnn.bricks.ConvTranspose2d: deconv_flops_counter_hook,
    }
