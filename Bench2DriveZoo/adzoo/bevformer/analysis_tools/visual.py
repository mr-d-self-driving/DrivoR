...
def render_sample_data(
    ...
    for ind, cam in enumerate(cams):
        ...
        if sensor_modality in ['lidar', 'radar']:
            ...
            # bench2driveMMCV.imwrite(np.array(data)[:,:,::-1], f'{cam}.png')
            # Init axes.
...
if __name__ == '__main__':
    ...
    bevformer_results = bench2driveMMCV.load('test/bevformer_base/Thu_Jun__9_16_22_37_2022/pts_bbox/results_nusc.json')
