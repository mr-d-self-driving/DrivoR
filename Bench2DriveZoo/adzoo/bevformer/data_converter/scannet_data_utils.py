...
class ScanNetData(object):
    ...
    def __init__(self, root_path, split='train'):
        ...
        bench2driveMMCV.check_file_exist(split_file)
        self.sample_id_list = bench2driveMMCV.list_from_file(split_file)
    ...
    def get_aligned_box_label(self, idx):
        ...
        bench2driveMMCV.check_file_exist(box_file)
    ...
    def get_axis_align_matrix(self, idx):
        ...
        bench2driveMMCV.check_file_exist(matrix_file)
    ...
    def get_infos(self, num_workers=4, has_label=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            bench2driveMMCV.mkdir_or_exist(osp.join(self.root_dir, 'points'))
            points.tofile(
            ...
            if not self.test_mode:
                ...
                bench2driveMMCV.mkdir_or_exist(osp.join(self.root_dir, 'instance_mask'))
                bench2driveMMCV.mkdir_or_exist(osp.join(self.root_dir, 'semantic_mask'))
...
class ScanNetSegData(object):
    ...
    def __init__(self,
        ...
        self.data_infos = bench2driveMMCV.load(ann_file)
        self.split = split
        assert split in ['train', 'val', 'test']
    ...
    def get_seg_infos(self):
        ...
        bench2driveMMCV.mkdir_or_exist(save_folder)
        np.save(
