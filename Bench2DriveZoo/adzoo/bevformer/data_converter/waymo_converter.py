...
class Waymo2KITTI(object):
    ...
    def convert(self):
        ...
        bench2driveMMCV.track_parallel_progress(self.convert_one, range(len(self)),
                                     self.workers)
        print('\nFinished ...')
    ...
    def save_image(self, frame, file_idx, frame_idx):
        ...
        for img in frame.images:
            ...
            img = bench2driveMMCV.imfrombytes(img.image)
            bench2driveMMCV.imwrite(img, img_path)
    ...
    def create_folder(self):
        ...
        for d in dir_list1:
            bench2driveMMCV.mkdir_or_exist(d)
        for d in dir_list2:
            for i in range(5):
                bench2driveMMCV.mkdir_or_exist(f'{d}{str(i)}')
