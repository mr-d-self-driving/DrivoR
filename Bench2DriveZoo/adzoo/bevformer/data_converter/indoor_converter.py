...
def create_indoor_info_file(data_path,
    ...
    if pkl_prefix == 'scannet':
        ...
        for split in splits:
            ...
            bench2driveMMCV.dump(info, filename, 'pkl')
