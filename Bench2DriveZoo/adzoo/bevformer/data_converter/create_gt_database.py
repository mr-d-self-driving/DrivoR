...
import numpy as np
import pickle
from bench2driveMMCV import track_iter_progress
from bench2driveMMCV.ops import roi_align
from os import path as osp
from pycocotools import mask as maskUtils
from pycocotools.coco import COCO

from bench2driveMMCV.core.bbox import box_np_ops as box_np_ops
from bench2driveMMCV.datasets import build_dataset
from bench2driveMMCV.core.evaluation.bbox_overlaps import bbox_overlaps
...
def create_groundtruth_database(dataset_class_name,
    ...
    bench2driveMMCV.mkdir_or_exist(database_save_path)
    all_db_infos = dict()
    if with_mask:
    ...
    for j in track_iter_progress(list(range(len(dataset)))):
        ...
        for i in range(num_obj):
            ...
            if with_mask:
                ...
                bench2driveMMCV.imwrite(object_img_patches[i], img_patch_path)
                bench2driveMMCV.imwrite(object_masks[i], mask_patch_path)
