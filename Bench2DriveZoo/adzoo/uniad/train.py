...
from bench2driveMMCV import __version__ as bench2driveMMCV_version
from bench2driveMMCV.datasets import build_dataset
from bench2driveMMCV.models import build_model
from bench2driveMMCV.utils import collect_env, get_root_logger, mkdir_or_exist, set_random_seed, get_dist_info, init_dist, \
                    Config, DictAction, TORCH_VERSION, digit_version
from bench2driveMMCV.datasets.builder import build_dataloader
from bench2driveMMCV.optims import build_optimizer
from torch.nn.parallel import DataParallel, DistributedDataParallel
from bench2driveMMCV.core.evaluation.eval_hooks import CustomDistEvalHook
from bench2driveMMCV.core import EvalHook
from bench2driveMMCV.runner import (HOOKS, DistSamplerSeedHook, EpochBasedRunner,
...
def main():
    ...
    if cfg.checkpoint_config is not None:
        cfg.checkpoint_config.meta = dict(bench2driveMMCV_version=bench2driveMMCV_version, config=cfg.pretty_text, CLASSES=datasets[0].CLASSES, \
