...
def mask_target(pos_proposals_list, pos_assigned_gt_inds_list, gt_masks_list,
    ...
    Example:
        ...
        >>> import mmdet
        >>> from bench2driveMMCV.core.mask import BitmapMasks
        >>> from bench2driveMMCV.core.mask.mask_target import *
        >>> H, W = 17, 18
        >>> cfg = bench2driveMMCV.Config({'mask_size': (13, 14)})
...
def mask_target_single(pos_proposals, pos_assigned_gt_inds, gt_masks, cfg):
    ...
    Example:
        ...
        >>> import mmdet
        >>> from bench2driveMMCV.core.mask import BitmapMasks
        >>> from bench2driveMMCV.core.mask.mask_target import *  # NOQA
        >>> H, W = 32, 32
        >>> cfg = bench2driveMMCV.Config({'mask_size': (7, 11)})
        >>> rng = np.random.RandomState(0)
