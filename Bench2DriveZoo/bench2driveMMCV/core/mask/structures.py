...
import torch
from bench2driveMMCV.ops.roi_align import roi_align
from bench2driveMMCV.image import rescale_size, imrescale, imresize, imflip, impad, imtranslate, imshear, imrotate
...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        For details can refer to `bench2driveMMCV.imrescale`.

        Args:
            scale (tuple[int]): The maximum size (h, w) of rescaled mask.
            interpolation (str): Same as :func:`bench2driveMMCV.imrescale`.
    ...
    def resize(self, out_shape, interpolation='nearest'):
        ...
        Args:
            ...
            interpolation (str): See :func:`bench2driveMMCV.imresize`.
    ...
    def crop_and_resize(self,
        ...
        Args:
            ...
            interpolation (str): See `bench2driveMMCV.imresize`
    ...
    def translate(self,
        ...
        Args:
            ...
            interpolation (str): Same as :func:`bench2driveMMCV.imtranslate`.
    ...
    def shear(self,
        ...
        Args:
            ...
            interpolation (str): Same as in :func:`bench2driveMMCV.imshear`.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    Example:
        >>> from bench2driveMMCV.core.mask.structures import *  # NOQA
    ...
    def translate(self,
        ...
        Example:
            >>> from bench2driveMMCV.core.mask.structures import BitmapMasks
    ...
    def random(cls,
        ...
        """
        from bench2driveMMCV.utils.util_random import ensure_rng
        rng = ensure_rng(rng)
...
class PolygonMasks(BaseInstanceMasks):
    ...
    def random(cls,
        ...
        Example:
            >>> from bench2driveMMCV.core.mask.structures import PolygonMasks
