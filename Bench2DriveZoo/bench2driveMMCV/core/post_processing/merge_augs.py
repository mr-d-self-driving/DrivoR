...
from bench2driveMMCV.ops import nms

from bench2driveMMCV.ops.iou3d_det.iou3d_utils import nms_gpu, nms_normal_gpu
...
def merge_aug_proposals(aug_proposals, img_metas, cfg):
    ...
    Args:
        ...
        img_metas (list[dict]): list of image info dict where each dict has:
            ...
            `bench2driveMMCV/datasets/pipelines/formatting.py:Collect`.
