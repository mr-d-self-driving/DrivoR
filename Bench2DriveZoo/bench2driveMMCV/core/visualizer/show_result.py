...
from bench2driveMMCV.utils import mkdir_or_exist
from bench2driveMMCV.image import imwrite
...
def show_multi_modality_result(img,
    ...
    if show:
        ...
        bench2driveMMCV.imshow(show_img, win_name='project_bbox3d_img', wait_time=0)
