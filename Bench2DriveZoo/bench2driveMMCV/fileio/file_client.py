...
from bench2driveMMCV.utils.misc import has_method
from bench2driveMMCV.utils.path import is_filepath, mkdir_or_exist
...
class CephBackend(BaseStorageBackend):
    ...
    .. warning::
        :class:`bench2driveMMCV.fileio.file_client.CephBackend` will be deprecated,
        please use :class:`bench2driveMMCV.fileio.file_client.PetrelBackend` instead.
    """
