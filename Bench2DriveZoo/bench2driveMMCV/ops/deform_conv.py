...
from bench2driveMMCV.utils import deprecated_api_warning
...
class DeformConv2dFunction(Function):
    ...
    def symbolic(g,
                 ...
                 im2col_step=32):
        return g.op(
            'bench2driveMMCV::bench2driveMMCVDeformConv2d',
            input,
            offset,
            weight,
            stride_i=stride,
...
class DeformConv2d(nn.Module):
    ...
    Note:
        ...
        flexibly and solved `issue bench2driveMMCV#1440
        <https://github.com/open-mmlab/bench2driveMMCV/issues/1440>`_.
