...
try:
    ...
    # and used; otherwise, auto fp16 will adopt bench2driveMMCV's implementation.
...
def auto_fp16(apply_to=None, out_fp32=False):
    ...
    backend, otherwise, original bench2driveMMCV implementation will be adopted.
...
def force_fp32(apply_to=None, out_fp16=False):
    ...
    torch.cuda.amp is used as the backend, otherwise, original bench2driveMMCV
...
def allreduce_grads(params, coalesce=True, bucket_size_mb=-1):
    warnings.warning(
        '"bench2driveMMCV.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "bench2driveMMCV.runner.allreduce_grads')
