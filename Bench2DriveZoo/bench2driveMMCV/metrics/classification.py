...
def to_categorical(tensor: torch.Tensor, argmax_dim: int = 1) -> torch.Tensor:
    ...
    .. warning :: Deprecated in favor of :func:`~bench2driveMMCV.pytorch_lightning.metrics.utils.to_categorical`

    """
    rank_zero_warn(
        "This `to_categorical` was deprecated in v1.1.0 in favor of"
        " `from bench2driveMMCV.pytorch_lightning.metrics.utils import to_categorical`."
...
def get_num_classes(
    ...
    .. warning :: Deprecated in favor of :func:`~bench2driveMMCV.pytorch_lightning.metrics.utils.get_num_classes`

    """
    rank_zero_warn(
        "This `get_num_classes` was deprecated in v1.1.0 in favor of"
        " `from bench2driveMMCV.pytorch_lightning.metrics.utils import get_num_classes`."
        " It will be removed in v1.3.0", DeprecationWarning
    )
...
def stat_scores_multiple_classes(
    ...
    .. warning :: Deprecated in favor of :func:`~bench2driveMMCV.pytorch_lightning.metrics.functional.stat_scores`
    ...
    rank_zero_warn(
        ...
        " `from bench2driveMMCV.pytorch_lightning.metrics.functional import stat_scores`."
