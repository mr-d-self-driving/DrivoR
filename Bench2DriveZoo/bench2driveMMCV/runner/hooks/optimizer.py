...
from bench2driveMMCV.utils import LossScaler, wrap_fp16_model, TORCH_VERSION, digit_version, allreduce_grads
...
if (digit_version(TORCH_VERSION) >= digit_version('1.6.0')):
    ...
    class Fp16OptimizerHook(OptimizerHook):
        ...
        Args:
            loss_scale (float | str | dict): Scale factor configuration.
                ...
                Defaults to 512. For Pytorch >= 1.6, bench2driveMMCV uses official
    ...
    @HOOKS.register_module()
    class Fp16OptimizerHook(OptimizerHook):
        """FP16 optimizer hook (bench2driveMMCV's implementation).
    ...
    class GradientCumulativeFp16OptimizerHook(GradientCumulativeOptimizerHook,
                                              Fp16OptimizerHook):
        """Fp16 optimizer Hook (using bench2driveMMCV implementation) implements multi-
