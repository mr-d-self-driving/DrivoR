...
from bench2driveMMCV.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            test function ``bench2driveMMCV.engine.single_gpu_test`` will be used.
            (default: ``None``)
        ...
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`bench2driveMMCV.fileio.FileClient` for details. Default: None.
            `New in version 1.3.16.`
    ...
    def evaluate(self, runner, results):
        ...
        Args:
            runner (:obj:`bench2driveMMCV.Runner`): The underlined training runner.
...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            ``None``, the default test function ``bench2driveMMCV.engine.multi_gpu_test``
            will be used. (default: ``None``)
