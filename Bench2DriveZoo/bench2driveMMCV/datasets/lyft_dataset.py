...
from bench2driveMMCV.core.evaluation.lyft_eval import lyft_eval
from bench2driveMMCV.datasets import DATASETS
from bench2driveMMCV.core import show_result
# from bench2driveMMCV.core.bbox import Box3DMode, Coord3DMode, LiDARInstance3DBoxes
from bench2driveMMCV.core.bbox.structures.box_3d_mode import Box3DMode
from bench2driveMMCV.core.bbox.structures.coord_3d_mode import Coord3DMode
...
class LyftDataset(Custom3DDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        """
        data = bench2driveMMCV.load(ann_file)
    ...
    def _format_bbox(self, results, jsonfile_prefix=None):
        ...
        for sample_id, det in enumerate(bench2driveMMCV.track_iter_progress(results)):
            annos = []
        ...
        bench2driveMMCV.dump(lyft_submissions, res_path)
        return res_path
    ...
    def json2csv(self, json_path, csv_savepath):
        ...
        """
        results = bench2driveMMCV.load(json_path)['results']
        ...
        bench2driveMMCV.mkdir_or_exist(os.path.dirname(csv_savepath))
