...
from bench2driveMMCV.fileio.io import dump,load
import numpy as np
from .builder import DATASETS
from bench2driveMMCV.datasets import NuScenesDataset
import pyquaternion
...
from bench2driveMMCV.utils.visual import save_tensor
...
class VADCustomNuScenesDataset(NuScenesDataset):
    ...
    def get_map_classes(cls, map_classes=None):
        ...
        if isinstance(map_classes, str):
            ...
            class_names = bench2driveMMCV.list_from_file(map_classes)
