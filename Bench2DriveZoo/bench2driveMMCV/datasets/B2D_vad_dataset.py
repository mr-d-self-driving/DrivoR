...
import mmcv
from bench2driveMMCV.datasets import DATASETS
from bench2driveMMCV.utils import save_tensor
from bench2driveMMCV.parallel import DataContainer as DC
from bench2driveMMCV.core.bbox.structures.lidar_box3d import LiDARInstance3DBoxes
from bench2driveMMCV.fileio.io import load, dump
from bench2driveMMCV.utils import track_iter_progress, mkdir_or_exist
from bench2driveMMCV.datasets.pipelines import to_tensor
from .custom_3d import Custom3DDataset
from .pipelines import Compose
from bench2driveMMCV.datasets.map_utils.struct import LiDARInstanceLines
...
from bench2driveMMCV.core.bbox.structures.nuscenes_box import CustomNuscenesBox
from shapely import affinity, ops
from shapely.geometry import LineString, box, MultiPolygon, MultiLineString
from nuscenes.map_expansion.map_api import NuScenesMap, NuScenesMapExplorer
from nuscenes.eval.detection.constants import DETECTION_NAMES
from bench2driveMMCV.datasets.map_utils.mean_ap import eval_map
from bench2driveMMCV.datasets.map_utils.mean_ap import format_res_gt_by_classes
from .nuscenes_styled_eval_utils import DetectionMetrics, EvalBoxes, DetectionBox, center_distance, accumulate, \
    DetectionMetricDataList, calc_ap, calc_tp, quaternion_yaw


@DATASETS.register_module()
class B2D_VAD_Dataset(Custom3DDataset):

    def __init__(self, queue_length=4, bev_size=(200, 200), overlap_test=False, with_velocity=True, sample_interval=5,
    ...
    def get_map_info(self, index):
        ...
        self.point_cloud_range[4] - self.point_cloud_range[1], self.point_cloud_range[3] - self.point_cloud_range[0]))
    ...
    def get_ego_trajs(self, idx, sample_rate, past_frames, future_frames):
        ...
        for j in range(len(adj_idx_list)):
            ...
            adj_yaw = adj_frame['ego_yaw']
            yaw = adj_yaw - cur_yaw
            xy = adj2cur_lidar[0:2, 3]
            full_adj_track[j, 0:2] = xy
            full_adj_track[j, 2] = yaw
    ...
    def _format_gt(self):
        ...
        if (not os.path.exists(self.map_ann_file)):
            ...
            prog_bar = bench2driveMMCV.ProgressBar(dataset_length)
    ...
    def _format_bbox(self, results, jsonfile_prefix=None, score_thresh=0.2):
        ...
        bench2driveMMCV.mkdir_or_exist(jsonfile_prefix)
