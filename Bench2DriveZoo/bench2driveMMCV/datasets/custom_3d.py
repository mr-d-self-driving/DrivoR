...
from bench2driveMMCV.datasets.builder import DATASETS
from ..core.bbox import get_box_type
from .pipelines import Compose
from .utils import extract_result_dict, get_loading_pipeline
from bench2driveMMCV.fileio.io import load, dump
from bench2driveMMCV.fileio.parse import list_from_file
...
class Custom3DDataset(Dataset):
    ...
    def evaluate(self,
        ...
        """
        from bench2driveMMCV.core.evaluation import indoor_eval
        assert isinstance(
