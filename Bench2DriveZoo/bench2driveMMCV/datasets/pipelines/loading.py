...
import torch
import bench2driveMMCV
import numpy as np
import pycocotools.mask as maskUtils
from einops import rearrange
from bench2driveMMCV.core.points import BasePoints, get_points_type
from bench2driveMMCV.fileio.file_client import FileClient
from bench2driveMMCV.image import imfrombytes, imread
from bench2driveMMCV.utils import check_file_exist
from bench2driveMMCV.core.mask.structures import BitmapMasks, PolygonMasks
# from bench2driveMMCV.datasets.pipelines.loading import LoadAnnotations, LoadImageFromFile
...
class LoadImageFromFile:
    ...
    Args:
        to_float32 (bool): Whether to convert the loaded image to a float32
            ...
            Defaults to False.
        color_type (str): The flag argument for :func:`bench2driveMMCV.imfrombytes`.
            Defaults to 'color'.
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`bench2driveMMCV.fileio.FileClient` for details.
    ...
    def __call__(self, results):
        ...
        Args:
            results (dict): Result dict from :obj:`bench2driveMMCV.CustomDataset`.
...
class LoadPointsFromMultiSweeps(object):
    ...
    Args:
        ...
        file_client_args (dict): Config dict of file clients, refer to
            https://github.com/open-mmlab/bench2driveMMCV/blob/master/bench2driveMMCV/fileio/file_client.py
...
class LoadAnnotations3D(LoadAnnotations):
    ...
    def _load_bboxes_3d(self, results):
        ...
        Args:
            results (dict): Result dict from :obj:`bench2driveMMCV3d.CustomDataset`.
...
class LoadMultiViewImageFromFilesInCeph(object):
    ...
    def __call__(self, results):
        ...
        # img is of shape (h, w, c, num_views)
        img = np.stack(
            #[bench2driveMMCV.imread(name, self.color_type) for name in filename], axis=-1)
...
class CustomLoadPointsFromMultiSweeps:
    ...
    def _load_points(self, lidar_path):
        ...
        Returns:
            np.ndarray: An array containing point clouds data.
        """
        bench2driveMMCV.check_file_exist(lidar_path)
