...
from bench2driveMMCV.core.bbox.structures.base_box3d import BaseInstance3DBoxes
from bench2driveMMCV.core.points import BasePoints
from bench2driveMMCV.utils import is_str
...
class ToDataContainer:
    """Convert results to :obj:`bench2driveMMCV.DataContainer` by given fields.

    Args:
        fields (Sequence[dict]): Each field is a dict like
            ``dict(key='xxx', **kwargs)``. The ``key`` in result will
            be converted to :obj:`bench2driveMMCV.DataContainer` with ``**kwargs``.
    ...
    def __call__(self, results):
        ...
        :obj:`bench2driveMMCV.DataContainer`.
