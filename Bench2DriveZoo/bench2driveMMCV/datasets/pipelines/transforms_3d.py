...
import warnings
from bench2driveMMCV import is_tuple_of
from bench2driveMMCV.utils import build_from_cfg
from bench2driveMMCV.parallel import DataContainer as DC

from bench2driveMMCV.core.voxel.voxel_generator import VoxelGenerator
from bench2driveMMCV.core.bbox.structures.cam_box3d import CameraInstance3DBoxes
from bench2driveMMCV.core.bbox.structures.depth_box3d import DepthInstance3DBoxes
from bench2driveMMCV.core.bbox.structures.lidar_box3d import LiDARInstance3DBoxes
from bench2driveMMCV.core.bbox import box_np_ops
from bench2driveMMCV.datasets.builder import PIPELINES
from bench2driveMMCV.datasets.pipelines.transforms import RandomFlip
from bench2driveMMCV.image import impad, impad_to_multiple, imnormalize, imresize, bgr2hsv, hsv2bgr
...
class RandomFlip3D(RandomFlip):
    ...
    def random_flip_data_3d(self, input_dict, direction='horizontal'):
        ...
        if 'centers2d' in input_dict:
            ...
            # https://github.com/open-mmlab/bench2driveMMCVection3d/pull/744
...
class PointSample(object):
    ...
    def __call__(self, results):
        ...
        if self.sample_range is not None:
            from bench2driveMMCV.core.points import CameraPoints
...
class CustomCollect3D(object):
    ...
    Args:
        ...
        meta_keys (Sequence[str], optional): Meta keys to be converted to
            ``bench2driveMMCV.DataContainer`` and collected in ``data[img_metas]``.
    ...
    def __call__(self, results):
        ...
        will be converted to :obj:`bench2driveMMCV.DataContainer`.
        Args:
