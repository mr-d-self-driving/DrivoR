...
from bench2driveMMCV.utils import is_list_of, is_str
from bench2driveMMCV.image import imrescale, imresize, imflip, impad, impad_to_multiple, imnormalize, bgr2hsv, hsv2bgr
    ...
    def _resize_img(self, results):
        ...
        for key in results.get('img_fields', ['img']):
            if self.keep_ratio:
                ...
                # a real fix should be done in the bench2driveMMCV.imrescale in the future
