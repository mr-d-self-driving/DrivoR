...
import numpy as np
from bench2driveMMCV.parallel import collate
from bench2driveMMCV.utils import Registry, build_from_cfg, get_dist_info
...
def build_dataset(cfg, default_args=None):
    from bench2driveMMCV.datasets.dataset_wrappers import CBGSDataset
    from bench2driveMMCV.datasets.dataset_wrappers import (ClassBalancedDataset,
