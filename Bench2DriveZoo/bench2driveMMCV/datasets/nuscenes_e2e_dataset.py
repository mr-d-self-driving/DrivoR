...
from bench2driveMMCV.datasets.data_utils.vector_map import VectorizedLocalMap
from bench2driveMMCV.datasets.data_utils.rasterize import preprocess_map
from bench2driveMMCV.datasets.eval_utils.map_api import NuScenesMap
from bench2driveMMCV.datasets.data_utils.trajectory_api import NuScenesTraj
...
class NuScenesE2EDataset(NuScenesDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        if self.file_client_args['backend'] == 'disk':
            # data_infos = bench2driveMMCV.load(ann_file)
