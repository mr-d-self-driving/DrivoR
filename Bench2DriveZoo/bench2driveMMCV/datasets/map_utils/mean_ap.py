...
import numpy as np
from bench2driveMMCV.utils import print_log
...
def format_res_gt_by_classes(result_path,
    ...
    if False:
        ...
        bench2driveMMCV.mkdir_or_exist(osp.abspath(show_dir))
...
def print_map_summary(mean_ap,
    ...
    Args:
        ...
        logger (logging.Logger | str | None): The way to print the mAP
            summary. See `bench2driveMMCV.utils.print_log()` for details. Default: None.
    """
