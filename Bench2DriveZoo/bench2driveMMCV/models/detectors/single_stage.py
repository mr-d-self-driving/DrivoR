...
from bench2driveMMCV.core.bbox.transforms import bbox2result
from bench2driveMMCV.models import DETECTORS, build_backbone, build_head, build_neck
...
class SingleStageDetector(BaseDetector):
    ...
    def forward_dummy(self, img):
        ...
        See `bench2driveMMCVection/tools/analysis_tools/get_flops.py`
        """
