...
from bench2driveMMCV.core.bbox.transforms import bbox3d2result
from bench2driveMMCV.core.visualizer import show_multi_modality_result


# from bench2driveMMCV.core import (CameraInstance3DBoxes, bbox3d2result,
#                           show_multi_modality_result)
from bench2driveMMCV.models.builder import DETECTORS
from bench2driveMMCV.models.detectors.single_stage import SingleStageDetector
from bench2driveMMCV.utils import is_list_of
from bench2driveMMCV.image import imread
...
class SingleStageMono3DDetector(SingleStageDetector):
    ...
    def forward_train(self,
        ...
        Args:
            ...
            img_metas (list[dict]): A List of image info dict where each dict
                ...
                :class:`bench2driveMMCV.datasets.pipelines.Collect`.
    ...
    def simple_test(self, img, img_metas, rescale=False):
        ...
        if self.bbox_head.pred_bbox2d:
            from bench2driveMMCV.core import bbox2result
            bbox2d_img = [
