from bench2driveMMCV.core import mask
import torch
from bench2driveMMCV.core.bbox.assigners.base_assigner import BaseAssigner

from bench2driveMMCV.core.bbox.assigners.assign_result import AssignResult
from bench2driveMMCV.core.bbox.transforms import bbox_cxcywh_to_xyxy
from bench2driveMMCV.core.bbox.match_costs import build_match_cost
from bench2driveMMCV.core.bbox.builder import BBOX_ASSIGNERS
try:
    from scipy.optimize import linear_sum_assignment
except ImportError:
    linear_sum_assignment = None

from bench2driveMMCV.core.bbox.samplers.base_sampler import BaseSampler
from bench2driveMMCV.core.bbox.builder import BBOX_SAMPLERS
from bench2driveMMCV.core import mask
import torch

from bench2driveMMCV.utils import util_mixins
...
class SamplingResult_segformer(util_mixins.NiceRepr):
    ...
    def random(cls, rng=None, **kwargs):
        ...
        Example:
            >>> from bench2driveMMCV.core.bbox.samplers.sampling_result import *  # NOQA
            >>> self = SamplingResult.random()
            >>> print(self.__dict__)
        """
        from bench2driveMMCV.core.bbox.samplers.random_sampler import RandomSampler
        from bench2driveMMCV.core.bbox.assigners.assign_result import AssignResult
        from bench2driveMMCV.core.bbox import demodata
