...
from bench2driveMMCV.core.anchor import (anchor_inside_flags, build_anchor_generator, images_to_levels)
from bench2driveMMCV.core.bbox.builder import (build_assigner, build_bbox_coder, build_sampler)
from bench2driveMMCV.core.utils import (multi_apply, unmap)
from bench2driveMMCV.core.post_processing.bbox_nms import (multiclass_nms)
...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
    ...
    def get_bboxes(self,
        ...
        Args:
            ...
            img_metas (list[dict]): Meta information of each image, e.g.,
                image size, scaling factor, etc.
            cfg (bench2driveMMCV.Config | None): Test / postprocessing configuration,
        ...
        Example:
            ...
            >>> cfg = bench2driveMMCV.Config(dict(
            >>>     score_thr=0.00,
    ...
    def _get_bboxes(self,
        ...
        Args:
            ...
            cfg (bench2driveMMCV.Config): Test / postprocessing configuration,
                if None, test_cfg would be used.
            rescale (bool): If True, return boxes in original image space.
                Default: False.
            with_nms (bool): If True, do nms before return boxes.
        ...
        for cls_score, bbox_pred, anchors in zip(mlvl_cls_scores,
            ...
            from bench2driveMMCV.core.export import get_k_for_topk
        ...
        if torch.onnx.is_in_onnx_export() and with_nms:
            from bench2driveMMCV.core.export import add_dummy_nms_for_onnx
        ...
        if self.use_sigmoid_cls:
            ...
            # remind that we set FG labels to [0, num_class-1] since bench2driveMMCV v2.0
            # BG cat_id: num_class
