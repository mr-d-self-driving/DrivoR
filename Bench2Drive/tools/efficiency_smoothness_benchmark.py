...
def read_from_json(filepath, metric_dir=None):
    ...
    for record in data["_checkpoint"]["records"]:
        filepath = os.path.join(metric_dir, 'shuffle_'+record["save_name"], 'metric_info.json')
        temp_dict = {}
...
if __name__=='__main__':
    ...
    argparser.add_argument('-f', '--file', default="eval_pad/merged.json", help='route file')
    argparser.add_argument('-m', '--metric_dir', default="eval_pad/")
