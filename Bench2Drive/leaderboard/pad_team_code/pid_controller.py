...
class PIDController(object):
    ...
    def __init__(self, turn_KP=0.75, turn_KI=0.75, turn_KD=0.3, turn_n=40, speed_KP=5.0, speed_KI=0.5, speed_KD=1.0,
                 speed_n=40, max_throttle=0.75, brake_speed=0.4, brake_ratio=1.1, clip_delta=0.25, aim_dist=12.0, #6.0,
    ...
    def control_pid(self, waypoints, speed, target):
        ...
        #desired_angle=np.degrees(np.pi / 2 - np.arctan2(waypoints[:,1], waypoints[:,0]).mean()) / 90
